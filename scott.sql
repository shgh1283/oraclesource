...
-- 40 번 부서의 부서명 DATABASE, LOC SEOUL 로 
UPDATE DEPT_TEMP2
...
-- DDL(데이터 정의어)
-- 데이터베이스 데이터를 보관하고 관리하기 위해 제공되는 여러 객체의 생성//삭제 관련기능 
-- CREATE(생성) / ALTER(생성된 객체 ) / DROP(생성된 객체 삭제)
